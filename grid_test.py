...
class Gridworld():
    ...
    def Grid(self):
        ...
        self.app = tk
        self.panvas = self.app.Canvas(bg = 'gray', height = 600, width = 600)
        self.panvas.pack()
        ...
        Q_values = self.panvas.create_rectangle(100, 100, 100, 100, fill = 'green')
        ...
        fire_pit_box = self.panvas.create_line(370, 150, 460, 150, 460, 240, 370, 240, 370, 150, fill='red', width=2)
